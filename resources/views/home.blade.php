            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="infotechno-hero-text  wow move-up">
                        <h6>Design & Consultation for IoT Engineering and IT Services</h6>
                        <h1 class="font-weight--reguler mb-15">The One-Stop Service For All IoT Engineering and IT Business Solution Providers</h1>
                        <p>Highly Customised IT Design, Management & Support Services.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="infotechno-hero-inner-images">
                        <div class="infotechno-inner-one">
                            <img class="img-fluid" src="{{asset('assets/images/hero/home-infotechno-main-slider-slide-01-image-01.webp')}}" alt="">
                        </div>
                        <div class="infotechno-inner-two  wow move-up">
                            <img class="img-fluid" src="{{asset('assets/images/hero/home-infotechno-main-slider-slide-01-image-02.webp')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up">
                                ...
                                <div class="ht-box-images style-01">
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <img class="img-fulid" src="{{asset('assets/images/icons/mitech-box-image-style-01-image-01-100x108.webp')}}" alt="">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up">
                                ...
                                <div class="ht-box-images style-01">
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <img class="img-fulid" src="{{asset('assets/images/icons/mitech-box-image-style-01-image-02-100x108.webp')}}" alt="">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up">
                                ...
                                <div class="ht-box-images style-01">
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <img class="img-fulid" src="{{asset('assets/images/icons/mitech-box-image-style-01-image-03-100x108.webp')}}" alt="">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="{{asset('assets/images/box-image/blog-01-330x330.webp')}}" width="330" height="330" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6  mt-30">
                                ...
                                <a href="#" class="box-large-image__wrap wow move-up">
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="{{asset('assets/images/box-image/mitech-home-infotechno-box-large-image-02-330x330.webp')}}" width="330" height="330" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6  mt-30">
                                ...
                                <a href="#" class="box-large-image__wrap wow move-up">
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="{{asset('assets/images/box-image/mitech-home-infotechno-box-large-image-03-330x330.webp')}}" width="330" height="330" class="img-fluid" alt="">
                            ...
                            <div class="swiper-wrapper testimonial-slider__wrapper">
                                    ...
                                    <div class="testimonial-slider__single wow move-up">
                                        ...
                                        <div class="author-info">
                                            <div class="testimonial-slider__media">
                                                <img src="{{asset('assets/images/testimonial/mitech-testimonial-avata-04-70x70.webp')}}" class="img-fluid" alt="">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slider__single wow move-up">
                                        ...
                                        <div class="author-info">
                                            <div class="testimonial-slider__media">
                                                <img src="{{asset('assets/images/testimonial/mitech-testimonial-avata-02-70x70.webp')}}" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__author">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slider__single wow move-up">
                                        ...
                                        <div class="author-info">
                                            <div class="testimonial-slider__media">
                                                <img src="{{asset('assets/images/testimonial/mitech-testimonial-avata-01-70x70.webp')}}" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__author">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slider__single wow move-up">
                                        ...
                                        <div class="author-info">
                                            <div class="testimonial-slider__media">
                                                <img src="{{asset('assets/images/testimonial/mitech-testimonial-avata-03-70x70.webp')}}" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__author">
            ...
            <div class="row">
                    ...
                    <div class="single-blog-item blog-grid">
                        ...
                        <div class="post-feature blog-thumbnail">
                            <a href="blog-post-layout-one.html">
                                <img class="img-fluid" src="{{asset('assets/images/blog/blog-03-370x230.webp')}}" alt="Blog Images">
                            </a>
                        </div>
                        <!-- Post Feature End -->
                ...
                <div class="col-lg-4 col-md-6 wow move-up">
                    ...
                    <div class="single-blog-item blog-grid">
                        ...
                        <div class="post-feature blog-thumbnail">
                            <a href="blog-post-layout-one.html">
                                <img class="img-fluid" src="{{asset('assets/images/blog/blog-02-370x230.webp')}}" alt="Blog Images">
                            </a>
                        </div>
                        <!-- Post Feature End -->
